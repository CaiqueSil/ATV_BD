...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/06/2025 às 14:10
...
--
-- Banco de dados: `sistema_petshop`
--
...
INSERT INTO `cliente` (`ID_Cliente`, `Nome`, `Rua`, `Estado`, `CEP`, `CPF`) VALUES
(1, 'Caique', 'SAO AGOSTO', 'BA', '48110000', '05971084550');
...
INSERT INTO `forma_pagamento` (`ID_Pagamento`, `forma_pagamento`) VALUES
(1, 'Cartao'),
(2, 'Pix'),
(3, 'Boleto'),
(4, 'Dinehiro');
